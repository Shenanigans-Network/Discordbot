...
class Server(commands.Cog):
    ...
    async def stats(self, ctx):
        ...
        stats_embed.add_field(name='<:latency:984861897574711316> Latency',value=f'{round(self.client.latency * 1000)}ms', inline=False)
        stats_embed.add_field(name='<:cpu:984861761377280030> CPU Usage', value=f'{server_info["cpuUsage"]}%',inline=False)
        stats_embed.add_field(name='<:ram:984861734449860659> Memory Usage', value=f'{server_info["memUsage"]}',inline=False)
        stats_embed.add_field(name='<:uptime:984861828855267498> Uptime', value=f'{server_info["uptime"]}',inline=False)
